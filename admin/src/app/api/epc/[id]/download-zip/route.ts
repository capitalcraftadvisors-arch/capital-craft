  ...
  try {
    ...
    void (async () => {
      try {
        ...
        // Download + append each document. Missing files are logged but
        // never abort the build — the ZIP still finalizes with whatever
        // GCS objects we could read + the summary.
        let included = 0;
        let missing = 0;
        ...
        // Excel summary — only other file in the ZIP besides the documents.
